export const bothDaysWithStay = (UUID: string) => {
	let steps = [
		{
			id: "are-you-free",
			message: "A celebration hard to miss is coming your way! Are you free on 15th and 16th February, 2023?",
		...
		},
		{
			id: "go-to-rsvp",
			message:
				"Woohoo! Awesome! Sanjana and Arjun are getting married on 15th and 16th February, 2023 in Delhi and we'd love for you to join us!",
			trigger: "rsvp",
		},
		{
			id: "rsvp",
